const CHAPTER1_DATA = {
  ...
  item_photo_add: {
    paragraphs: ['照片滑进箱子侧袋。你感觉它轻轻叹了口气——或者是箱子在叹气。'],
    next: 'opening_room'
  },
  ...
  item_scarf_add: {
    paragraphs: ['围巾柔软地蜷在箱子角落。你想起那个人说的话："冷了记得围。"'],
    next: 'opening_room'
  },
  ...
  item_letter_add: {
    paragraphs: ['信躺在箱底，安安静静的。你不打算寄它。但你打算带着它。'],
    next: 'opening_room'
  },
  ...
  item_stone_add: {
    paragraphs: ['石头沉甸甸地落进口袋。你感到一种奇怪的安心——好像它在说："我帮你坠着。"'],
    next: 'opening_room'
  },
  ...
  item_mp3_add: {
    paragraphs: ['没有电池的 MP3 轻得几乎没有重量。但你知道它在。'],
    next: 'opening_room'
  },
